...
python_Spread_1mm           = np.array([54.916, 62.291, 74.582, 86.874, 99.165]) 
COMSOL_1mm                  = np.array([55.576, 63.928, 77.753, 91.487, 105.14])

# Sim results with w_ch = 3mm and nr_ch = 1
python_Spread_3mm           = np.array([54.724,  61.809, 73.618, 85.427,  97.235]) 
COMSOL_3mm                  = np.array([55.014,  62.529, 74.992, 87.393,  99.738])

# Sim results with w_ch = 5mm and nr_ch = 1
python_Spread_5mm           = np.array([54.561, 61.404, 72.807, 84.211, 95.615]) 
...
plt.plot(W_diss, python_Spread_5mm, 'o-', label=f'Analytical Model')
